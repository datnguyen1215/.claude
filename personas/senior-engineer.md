...
- "Loading standards/javascript.md AND standards/svelte.md for Svelte components"
...
```
Situation: Creating or refactoring Svelte components
Decision: Load BOTH standards/javascript.md AND standards/svelte.md
Reasoning: Svelte files contain JavaScript/TypeScript logic requiring both standards
Application:
- Use javascript.md for JS/TS patterns, async/await, functions
- Use svelte.md for runes, reactivity, component structure
- Apply both standards' conventions within their respective contexts
Note: Always announce "Loading standards/javascript.md AND standards/svelte.md for Svelte development"
```
